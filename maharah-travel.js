        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/maharahtravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    {
        title: 'عروض النمسا',
        image_1: ['عروض-شركة-مهارة/عروض-النمسا/عرض-النمسا-1.jpg', 'سالزبورغ & إنسبروك & زيل أم سي'],
        image_2: ['عروض-شركة-مهارة/عروض-النمسا/عرض-النمسا-2.jpg', 'النمسا & المجر & سلوفاكيا & التشيك'],
        image_3: ['عروض-شركة-مهارة/عروض-النمسا/عرض-النمسا-3.jpg', 'النمسا & المانيا & التشيك'],
    },

    {
        title: 'عروض تايلاند',
        image_1: ['عروض-شركة-مهارة/عروض-تايلاند/عرض-تايلاند-1.jpg', 'بانكوك & كرابي & جزيرة بوكيت'],
    },

    {
        title: 'عروض جورجيا',
        image_1: ['عروض-شركة-مهارة/عروض-جورجيا/عرض-جورجيا-1.jpg', 'بورجومي & باكورياني'],
    },

    {
        title: 'عروض ماليزيا',
        image_1: ['عروض-شركة-مهارة/عروض-ماليزيا/عرض-ماليزيا-1.jpg', 'كوالالمبور & جزيرة لانكاوي'],
    },

    {
        title: 'عروض تركيا',
        image_1: ['عروض-شركة-مهارة/عروض-تركيا/عرض-تركيا-1.jpg', 'طرابزون & اسطنبول'],
    },

    {
        title: 'عروض اذربيجان',
        image_1: ['عروض-شركة-مهارة/عروض-اذربيجان/عرض-اذربيجان-1.jpg', 'باكو & جبالا & قوبا'],
    },

    {
        title: 'عروض ارمينيا',
        image_1: ['عروض-شركة-مهارة/عروض-ارمينيا/عرض-ارمينيا-1.jpg', 'عرض ارمينيا - 8 أيام'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+966532003999?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/maharahtravel/${encodeURIComponent(src)}`;
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا شركة مهارة على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة مهارة على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة مهارة على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا  شركة مهارة للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة مهارة للسفر والسياحة ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة مهارة`;
            img.title = `مكتب سياحي - شركة مهارة`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+966532003999";
